...
function buscarCEP() {
    ...
    // Pequeno delay para a experiência ser mais suave (opcional)
    ...
    setTimeout(() => {
        ...
        fetch(url)
            ...
            .then(data => {
                ...
                // Se o complemento estiver vazio, habilitará o campo e mostrará o modal
...
// Adicionará um Event Listener ao campo CEP para chamar buscarCEP quando o usuário sair do campo (onblur)

document.getElementById('cep').addEventListener('blur', buscarCEP);

// Opcional - Previne o envio do formulário para demonstração (poderá ser removido caso queira enviar dados)
